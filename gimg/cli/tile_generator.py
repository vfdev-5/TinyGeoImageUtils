...
@click.option('--extensions', type=str, default=None, help="String of file extensions to select, e.g. 'jpg,png,tif'")
...
def run_const_size_tiler(input_dir, output_dir, tile_size_in_pixels, min_overlapping_in_pixels, extensions,
